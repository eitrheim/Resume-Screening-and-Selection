...
#TODO could this be used instead: https://github.com/euske/pdfminer/blob/master/tools/pdf2txt.py
...
def maketheparser():
    ...
    parser.add_argument("files", type=str, default=None, nargs="+", help="File to process.")  # "+" means to gather into a list and throw an error if there wasn't at least one agrument (i.e. file) present
    parser.add_argument("-d", "--debug", default=False, action="store_true", help="Debug output.")  # create default value of True
    ...
    parser.add_argument("-m", "--maxpages", type=int, default=0, help="Maximum pages to parse")  # interpret as integer
