...
PlaceboTest = "All"
job_text = job_text.head(50)
resume_text = resume_text.head(500)
...
train_auc = auc_score(pos_model, pos_train, num_threads=NUM_THREADS).mean()
print('train AUC: %s' %train_auc)
test_auc = auc_score(pos_model, pos_test, num_threads=NUM_THREADS).mean()
